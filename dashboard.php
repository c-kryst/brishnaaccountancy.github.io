...
<div class="container-fluid">
	...
	<br />
	<div class="card">
		<div class="card-header"><h4>Accountant Schedule List</h4></div>
			<div class="card-body">
    	...
    	<form method="post" id="appointment_form">
      		<div class="modal-content">
        		...
        		<div class="modal-footer">
          			<input type="hidden" name="hidden_accountant_id" id="hidden_accountant_id" />
          			<input type="hidden" name="hidden_accountant_schedule_id" id="hidden_accountant_schedule_id" />
...
$(document).ready(function(){
	...
	$(document).on('click', '.get_appointment', function(){
		...
		var accountant_schedule_id = $(this).data('accountant_schedule_id');
		var accountant_id = $(this).data('accountant_id');

		$.ajax({
			url:"action.php",
			method:"POST",
			data:{action:'make_appointment', accountant_schedule_id:accountant_schedule_id},
			success:function(data)
			{
				$('#appointmentModal').modal('show');
				$('#hidden_accountant_id').val(accountant_id);
				$('#hidden_accountant_schedule_id').val(accountant_schedule_id);
